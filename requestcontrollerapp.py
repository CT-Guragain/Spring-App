...
app.config["MAX_CONTENT_LENGTH"] = 100_000  # reject any request body over ~100KB outright
db = SQLAlchemy(app)
...
if __name__ == "__main__":
    ...
    #
    # DEMO DAY: set debug=False (as below). Debug mode exposes an interactive
    # in-browser Python debugger on unhandled errors — fine while you're
    # developing alone, but a real risk once other people can reach your
    # machine's IP during a live demo.
